...
namespace PrairieKingSkill
{
    class Util
    {
        ...
        public static void extendExpLength(int skillIndex)
        {
            if (Game1.player.experiencePoints.Length < skillIndex + 1)
            {
                int[] newExp = new int[skillIndex + 1];
        ...
        public static int GetNumOtherSkills(IModHelper helper)
        {
            int numSkills = 5;
